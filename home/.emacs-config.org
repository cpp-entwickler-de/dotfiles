...
Open                             ^^Save                      ^^Close                  ^^Switch             ^^Version                    ^^Display                       ^^File                           ^^^^^^Encoding
      ...
      _t_: Test                      _I_: Private gist           _a_: Close editor                           ^^_b_: Blame                   _&_: Encode Base64              _c_: Copy name to clipboard
  _<RET>_: File under cursor                                                                             ^^^^^^_T_: Trace lines                                           ^^_._: Open directory
      _k_: Gist                      _e_: Encrypt                                                                                                                   ^^^^^^^^_+_: Show Directory Tree
