...
Open                         ^^Save           ^^Close                  ^^Switch               ^^Version                    ^^Display                       ^^File                           ^^^^^^Encoding
      ...
      _C_: From docker container                ^^_a_: Close editor                             ^^_i_: Create public gist      _&_: Encode Base64              _c_: Copy name to clipboard
                                                                                          ^^^^^^^^_I_: Create private gist                                   ^^_._: Open directory
