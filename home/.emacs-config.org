...
#+BEGIN_SRC emacs-lisp
(with-eval-after-load "typo-mode"
...
CMake              ^^Git           ^^Directories         ^^Shell
  ...
  _r_: Reconfigure                   ^^_d_: Subdirectory     q_%_: Build directory
  _-_: Reset                         ^^_b_: Build
  _x_: Close
"
...
Open                         ^^Save           ^^Close                  ^^Switch               ^^Version                  ^^Display                       ^^File                           ^^^^^^Encoding
      ...
      _r_: Recent                _a_: Save as     _X_: Other files           _l_: Last file                                ^^_!_: Toggle read-only mode      _m_: Rename                      ^^^^_C-u_: UNIX
      _p_: From project                         ^^_w_: File and window                                                                                 ^^^^^^_c_: Copy name to clipboard
      _P_: From all projects                    ^^_u_: Unused files                                                                                    ^^^^^^_._: Open directory
...
"
  ...
  ("t" (lambda()
         (interactive)
         (find-file org-default-todos-file)))
  ("b" (lambda()
         (interactive)
         (find-file org-default-bugs-file)))
  ("n" (lambda()
         (interactive)
         (find-file org-default-notes-file)))
  ("e" (lambda()
         (interactive)
         (find-file org-default-events-file)))
...
"
  ...
  ("c" (lambda ()
         (interactive)
         (kill-ring-save nil nil t)) :exit t)
  ("d" (lambda ()
         (interactive)
         (call-interactively #'delete-region)) :exit t)
  ("k" (lambda ()
         (interactive)
         (kill-region nil nil t)) :exit t))
...
"
  ...
  ("t" (lambda ()
         (interactive)
         (custom-theme-visit-theme cpped-theme))))
...
"
  ...
  ("B" (lambda ()
         (interactive)
         (let ((cpped-cmake-current-target nil))
