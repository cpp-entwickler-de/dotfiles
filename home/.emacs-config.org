...
(cpped-create-agenda-file org-default-events-file)
...
(setq cpped-org-todo-keyword-todo "⚠ To Do"
      ...
      org-todo-keywords `((sequence ,(concat cpped-org-todo-keyword-todo "(t)") "|" ,(concat cpped-org-todo-keyword-done "(d!/@)"))
                          ...
                          (sequence ,(concat cpped-org-todo-keyword-in-progress "(p!)") ,(concat cpped-org-todo-keyword-waiting "(w@/!)") ,(concat cpped-org-todo-keyword-suspended "(s@/!)") ,(concat cpped-org-todo-keyword-review "(r!/!)"))
...
(setq org-capture-templates
      `(("t" "To Do" entry (file+headline org-default-todos-file "ToDos") ,(concat "** " cpped-org-todo-keyword-todo " [#B] %? %^g\n%U\n:CATEGORY: ToDos\nSCHEDULED: %t\n%i\n") :empty-lines 1 :kill-buffer t)
        ...
        ("n" "Note" entry (file+headline org-default-notes-file "Notes") "** %? %^g\n%U\n:CATEGORY: Notes\n%i\n" :empty-lines 1 :kill-buffer t)))
#+END_SRC
...
(setq org-agenda-compact-blocks t
      ...
      org-agenda-prefix-format '((agenda  . "  %l%-10T%?-12t% s  ")
                                 (timeline  . "  %l% s")
                                 (todo  . "  %l%-6T%?-12t")
                                 (tags  . "  %l%-6T")
                                 (search . "  %l%-6T"))
...
(setq org-agenda-custom-commands '(("d" "Default agenda view"
                                    ((agenda "" ((org-agenda-skip-function '(let ((tags (save-excursion
                                                                              ...
                                                                              (if (or (member "Appointment" tags)
                                                                                      ...
                                                                                      (member "Holiday" tags))
                                                                                  nil
                                                                                (org-agenda-skip-entry-if 'done 'notscheduled))))))
