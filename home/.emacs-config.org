...
_C-<right>_: Next word                 _y_: Down block                 _C-t_: Next ToDo                                     ^^_C-q_: XQuery
   _<home>_: Beginning of line         _q_: Left block                   _t_: Select ToDo                                     ^^_C-x_: XPath
...
☰ Edit
  ...
  ___: Overwrite Mode                                                            ^^^^_C_: Color         _=_: Align                                                            ^^^^_o_: Split org-mode code block
...
Settings                       ^^Snippets            ^^Abbreviations             ^^Packages
  _c_: Open config file            _Y_: New snippet      _A_: New abbreviation       _p_: System packages
