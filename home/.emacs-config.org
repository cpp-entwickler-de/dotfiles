...
#+BEGIN_SRC emacs-lisp
(defvar cpped-buffer-names-alist nil "A list of buffer name transformations.")
    ...
    (let* ((home-dir (getenv "HOME"))
           ...
           (relative-path (when filename
                            (file-name-directory (if project-root
                                                   ...
                                                   filename))))
           (buffer-name (let ((name (format-mode-line "%b")))
                          (or (cdr (assoc name cpped-buffer-names-alist))
                              name)))
...
#+BEGIN_SRC emacs-lisp
(push `(,(file-name-nondirectory org-default-bugs-file) . "*Bugs*") cpped-buffer-names-alist)
(push `(,(file-name-nondirectory org-default-todos-file) . "*ToDos*") cpped-buffer-names-alist)
(push `(,(file-name-nondirectory org-default-events-file) . "*Events*") cpped-buffer-names-alist)
(push `(,(file-name-nondirectory org-default-notes-file) . "*Notes*") cpped-buffer-names-alist)
#+END_SRC
