...
(add-hook 'eshell-mode-hook (lambda()
                              (set (make-local-variable 'company-backends) '(company-shell company-keywords company-dabbrev-code company-yasnippet company-files company-capf cpped-company-line-backend))))
#+END_SRC
...
(add-hook 'c-mode-common-hook (lambda()
                                (set (make-local-variable 'company-backends) '(company-rtags company-c-headers company-keywords company-yasnippet company-files company-capf company-dabbrev-code cpped-company-line-backend))))
#+END_SRC
...
(add-hook 'cmake-mode-hook (lambda()
                             (set (make-local-variable 'company-backends) '(company-cmake company-yasnippet company-files company-capf company-dabbrev-code cpped-company-line-backend))))
#+END_SRC
...
(add-hook 'elisp-mode-hook (lambda()
                             (set (make-local-variable 'company-backends) '(company-elisp company-keywords company-yasnippet company-files company-capf company-dabbrev-code cpped-company-line-backend))))
#+END_SRC
...
(add-hook 'qml-mode-hook (lambda()
                           (set (make-local-variable 'company-backends '(company-qml company-keywords company-yasnippet company-files company-capf company-dabbrev-code cpped-company-line-backend)))))
#+END_SRC
...
(use-package company-shell
  ...
  (add-hook 'sh-mode-hook (lambda()
                            (set (make-local-variable 'company-backends) '(company-shell company-keywords company-yasnippet company-files company-capf company-dabbrev-code cpped-company-line-backend)))))
#+END_SRC
...
(add-hook 'nxml-mode-hook (lambda() 
                                  (set (make-local-variable 'company-backends) '(company-nxml company-yasnippet company-files company-capf company-dabbrev-code cpped-company-line-backend))))
#+END_SRC
...
CMake              ^^Git                         ^^Directories         ^^Shell                    ^^Other
  _o_: Load            _g_: Status                   _/_: Project          _#_: Project directory     _l_: Add change log entry
  _c_: Configure       _G_: Other Project Status     _._: Current          _$_: Current directory     _t_: Show ToDos
...
☰ Edit
  ...
  _d_: Duplicate               _n_: Local         _r_: Regex          _c_: Case         ^_>_: Indentation        _t_: Translate     _/_: Comment                   _a_: Add
