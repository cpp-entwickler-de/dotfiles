...
(use-package helm
  ...
  (define-key helm-map (kbd "C-M-y") 'helm-copy-to-buffer)
...
(use-package uncrustify-mode
  :after system-packages
  :config (cpped-install-system-package "uncrustify"))
#+END_SRC
...
(setq org-agenda-custom-commands '(("D" "Default agenda view"
                                   ...
                                   ("p" "Monthly Timesheet" agenda ""
                                    ((org-agenda-overriding-header (concat (if (< (nth 3 (decode-time)) 4)
                                                                               "Last"
                                                                             "This")
                                                                           " Month"))
...
☰ Project 📁 %s(or (ignore-errors (projectile-project-root))
                   default-directory)%s(if cmake-ide-build-dir
...
CMake              ^^Git                         ^^Directories         ^^Shell                    ^^Other
  ...
  _r_: Reconfigure                                 ^^_d_: Subdirectory                              ^^_t_: Show ToDos
  _-_: Reset           _v_: Clone                    _b_: Build            _B_: Build directory
  _x_: Close           _V_: Clone from GitHub
"
...
Open                         ^^Save           ^^Close                  ^^Switch               ^^Version                    ^^Display                       ^^File                           ^^^^^^Encoding
      ...
      _P_: From all projects                    ^^_u_: Unused files                             ^^_b_: Blame                   _6_: Decode Base64              _c_: Copy name to clipboard
                                              ^^^^_a_: Close editor                             ^^_i_: Create public gist      _&_: Encode Base64              _._: Open directory
      _j_: Header/Source                                                                    ^^^^^^_I_: Create private gist                                   ^^_+_: Show Directory Tree
      _t_: Test
...
Text                    ^^Code                                ^^Version Control         ^^System             ^^Other
  ...
  _s_: Synonym              _r_: References                                               ^^_I_: Info page
  _g_: Google               _-_: Dependencies
  _o_: Preview markdown     _e_: Enum value
  _._: Cursor               _i_: Include files for symbol
                          ^^_P_: Dependencies
                          ^^_f_: Functions called
                          ^^_v_: Virtual functions
                          ^^_+_: Preprocess
...
☰ Edit
  ...
  _i_: Insert                                                          ^^^^_+_: Value +              ^_j_: Join lines         _l_: Spelling      _X_: Fixit
  _'_: Quoted insert                                                   ^^^^_-_: Value -              ^_:_: Fill paragraph     _s_: Sort          _e_: Evaluate
  _<_: Complete                                                        ^^^^_#_: Base             ^_<tab>_: Spaces → Tabs      _x_: Transpose     _E_: Evaluate & Replace
  _g_: Edit area                                                       ^^^^_1_: Flip bool    ^_<backtab>_: Tabs → Spaces                       ^^_._: Suggestion
  ___: Overwrite Mode                                                  ^^^^_C_: Color                                                       ^^^^^_F_: Format
  _&_: Typographic Mode                                                ^^^^_L_: To Link                                                     ^^^^^_u_: Uncrustify
                                                                     ^^^^^^_6_: Decode Base64
...
Open                ^^Create       ^^Task                     ^^Chart
  _a_: Agenda           _c_: Entry     _i_: Clock in              _d_: Daily timesheet
  _u_: Current Task                  ^^_o_: Clock out             _m_: Monthly timesheet
                                   ^^^^_e_: Set estimate
  _t_: ToDos                         ^^_+_: Increase estimate
  _b_: Bugs
  _n_: Notes
  _e_: Events
"
