...
Open                         ^^Save           ^^Close                  ^^Switch               ^^Version                    ^^Display                       ^^File                           ^^^^^^Encoding
      ...
      _P_: From all projects                    ^^_u_: Unused files                             ^^_b_: Blame                   _6_: Decode Base64              _z_: Clear content
                                              ^^^^_a_: Close editor                             ^^_i_: Create public gist      _&_: Encode Base64              _c_: Copy name to clipboard
      _j_: Header/Source                                                                    ^^^^^^_I_: Create private gist                                   ^^_._: Open directory
      _t_: Test                                                                                                                                      ^^^^^^^^^^_+_: Show Directory Tree
