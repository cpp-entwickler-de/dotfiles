...
(use-package system-packages
  ...
  (add-to-list 'system-packages-supported-package-managers
               ...
               t)
  (system-packages-install "python-pip")
  (defun cpped-pip-install (package)
    "Install a package via pip."
    (let ((system-packages-packagemanager 'pip) )
  ...
  (defun cpped-npm-install (package)
    "Install a package via npm."
    (let ((system-packages-packagemanager 'npm))
      (system-packages-install package)))
  (add-to-list 'system-packages-supported-package-managers
               '(gem .
                     ((default-sudo . nil)
               ...
               t)
  (system-packages-install "rubygems")
  (defun cpped-gem-install (package)
    "Install a package via gem."
    (let ((system-packages-packagemanager 'gem))
      (system-packages-install package))))
#+END_SRC
...
(defun powerline-term-input-mode (icon-face)
                  ...
                  (:eval
                   (let* ((active (powerline-selected-window-active))
                          ...
                          (lhs (list
                                ...
                                (powerline-raw (powerline-term-input-mode (symbol-value 'face2)) face2 'l)
...
(use-package ag
  ...
  :config (system-packages-install "the_silver_searcher"))
...
(use-package synosaurus
  :after system-packages
  :config
  (system-packages-install "wordnet")
...
(use-package flyspell
  ...
  (system-packages-install "aspell-en")
  (system-packages-install "aspell-de")
...
(use-package cmake-ide
  :after system-packages
  :config
  (system-packages-install "cmake")
  (system-packages-install "ccmake")
  (system-packages-install "ninja-build")
...
(use-package howdoi
  :after system-packages
  :config (cpped-pip-install "howdoi"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(with-eval-after-load "system-packages"
  (system-packages-install "sloccount")
...
(use-package uncrustify-mode
  :after system-packages
  :config (system-packages-install "uncrustify"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(with-eval-after-load "system-packages"
  (system-packages-install "cppcheck")
...
#+BEGIN_SRC emacs-lisp
(with-eval-after-load "system-packages"
  (system-packages-install "csslint")
  (cpped-npm-install "stylelint")
...
#+BEGIN_SRC emacs-lisp
(with-eval-after-load "system-packages"
  (cpped-npm-install "standard")
  (cpped-npm-install "jscs")
  (cpped-npm-install "eslint")
  (cpped-npm-install "jshint")
  (cpped-npm-install "jslint")
...
(use-package flycheck-checkbashisms
  ...
  :config
  (system-packages-install "devscripts-checkbashisms")
...
(use-package plantuml-mode
  ...
  :mode "\\.p\\(lant\\)?uml\\'"
  :config
  (system-packages-install "plantuml")
...
#+BEGIN_SRC emacs-lisp
(with-eval-after-load "system-packages"
  (system-packages-install "libxml2")
  (system-packages-install "xmlstarlet")
  (add-hook 'nxml-mode-hook (lambda ()
...
(defvar prettify-magit-alist (list (list (rx bol (+ (in "0-9a-f")) (+ (in space punctuation)) bow (group "add" (? (or "s" "ed"))) eow)
                                   ...
                                   (list (rx bol (+ (in "0-9a-f")) (+ (in space punctuation)) bow (group (or "remove" "delete") (? (in "sd"))) eow)
                                         ...
                                         `(:family ,(all-the-icons-faicon-family)))
                                   (list (rx bol (+ (in "0-9a-f")) (+ (in space punctuation)) bow (group "fix" (? "e" (in "sd"))) eow)
                                   ...
                                   (list (rx bol (+ (in "0-9a-f")) (+ (in space punctuation)) bow (group "decrease" (? (in "sd"))) eow)
                                         ...
                                         `(:family ,(all-the-icons-faicon-family)))
                                   (list (rx bol (+ (in "0-9a-f")) (+ (in space punctuation)) bow (group "enable" (? (in "sd"))) eow)
...
(use-package pdf-tools
  ...
  :config
  (system-packages-install "poppler-devel")
  (system-packages-install "poppler-glib-devel")
...
(use-package gnuplot
  ...
  :config
  (system-packages-install "gnuplot")
...
Open                         ^^Save           ^^Close                  ^^Switch               ^^Version                  ^^Display                       ^^File                           ^^^^^^Encoding
      ...
      _r_: Smart/Recent          _a_: Save as     _X_: Other files           _l_: Last file       _D_: Diff                  _!_: Toggle read-only mode      _m_: Rename                      ^^^^_C-u_: UNIX
      _p_: From project                         ^^_w_: File and window       _f_: Find            _g_: Log                                                 ^^_z_: Clear content
      _P_: From all projects                    ^^_u_: Unused files                             ^^_b_: Blame                                               ^^_c_: Copy name to clipboard
...
Text                    ^^Code                                ^^Version Control         ^^System             ^^Other
  _#_: Number               _y_: Symbol Info                      _c_: Commit Message       _p_: Processes       _t_: ToDos
  _x_: Translate            _d_: Documentation                    _b_: Blame                _m_: Man page        _w_: Weather
  _s_: Synonym              _r_: References
...
Namespace
  _w_: Wrap function/region
  _r_: Rename enclosing
  _R_: Rename
...
"
  ...
  ("r" outrespace-change-enclosing-ns-name)
  ("R" outrespace-change-ns-name)
...
☰ Edit
  ...
  _i_: Insert                                                     ^^^^_+_: Value +              ^_j_: Join lines         _l_: Spelling      _e_: Evaluate
  ...
  ___: Overwrite Mode                                             ^^^^_C_: Color                                                       ^^^^^_u_: Uncrustify
