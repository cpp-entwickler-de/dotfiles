...
(use-package projectile
  ...
  (defun shark-bytes/switch-project (&optional arg)
    ...
    (if-let* ((projects (mapcar #'(lambda (project)
                                    (cons (directory-file-name (or (car (-non-nil (mapcar (lambda (project-directory)
                                                                                        (let ((full-project-base (expand-file-name project-directory))
                                                                                              (full-current-project (expand-file-name project)))
                                                                                          (when (string-match (concat "^" full-project-base ".*") full-current-project)
                                                                                            (file-relative-name full-current-project full-project-base))))
                                                                                      shark-bytes/project-directories))) "")) project))
