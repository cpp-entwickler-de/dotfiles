...
(custom-theme-set-faces
 ...
 '(shark-bytes-ui ((t (:family "Noto Sans Nerd Font"))))
 ...
 `(default ((t (:inherit nil :stipple nil :background ,shark-bytes-window-background :foreground ,shark-bytes-text :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width condensed :family "FiraCodeNerdFont"))))
 ...
 `(rainbow-delimiters-depth-1-face ((t (:foreground ,shark-bytes-freezing :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-2-face ((t (:foreground ,shark-bytes-icy :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-3-face ((t (:foreground ,shark-bytes-cold :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-4-face ((t (:foreground ,shark-bytes-chilly :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-5-face ((t (:foreground ,shark-bytes-bleak :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-6-face ((t (:foreground ,shark-bytes-mild :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-7-face ((t (:foreground ,shark-bytes-cozy :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-8-face ((t (:foreground ,shark-bytes-warm :inherit rainbow-delimiters-base-face))))
 `(rainbow-delimiters-depth-9-face ((t (:foreground ,shark-bytes-hot :inherit rainbow-delimiters-base-face))))
